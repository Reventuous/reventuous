...
namespace Reventuous.Subscriptions.Redis {
    /// <summary>
    /// A persistent subscription for Redis streams, using the $all stream
    ...
    /// </summary>
    [PublicAPI]
    public class StreamPersistentSubscription : RedisSubscriptionService {
        ...
        protected override async Task<EventSubscription> Subscribe(
            ...
            var subTask = RedisPersistentSubscription.Confirm(
                Database,
